...
import activities from './server/activities/index.js';
import coros from './server/coros/index.js';
import decathlon from './server/decathlon/index.js';
import { defaultErrorHandler } from './server/error-handler.js';
import garmin from './server/garmin/index.js';
import health from './server/health/index.js';
import polar from './server/polar/index.js';
import strava from './server/strava/index.js';
import suunto from './server/suunto/index.js';
